...
| T13 | At 60 digits, the fixed Markoff points of the metallic rules: m = 1 gives x² − 3x + 3 (disc −3) and nothing else; m = 2 gives x⁴ − 4x² + 8 with invariant field ℚ(x²) = ℚ(i); m = 3 an octic. From the rule side, conductor 3 is m = 1 alone. (m = 4 candidates left unidentified: see PLAN.) | `theorems/T13_metallic_fields.py` |
